...
// Явно отдаем index.html на главной странице
app.get('/', (req, res) => {
...
if (fs.existsSync(DB_FILE)) {
    try {
        ...
        console.error("Ошибка чтения БД, сброс к дефолту", e);
    }
}
